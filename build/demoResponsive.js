...
/***/ function(module, exports, __webpack_require__) {
	...
	var Demo = function (_React$Component) {
	  ...
	  function Demo(props) {
	    ...
	    defaultValue = _index.ViewerHelper.fitSVGToViewer(defaultValue, 1440, 1440, 500, 500);
	  ...
	  _createClass(Demo, [{
	    ...
	    value: function handleReset(event) {
	      var _refs$viewer$state = this.refs.viewer.state;
	      var containerWidth = _refs$viewer$state.containerWidth;
	      var containerHeight = _refs$viewer$state.containerHeight;

	      this.setState({ value: _index.ViewerHelper.fitSVGToViewer(this.state.value, 1440, 1440, containerWidth, containerHeight) });
	    }
	  }, {
	    key: 'handleClick',
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _index.ViewerResponsive,
	            { style: { border: '1px solid black' }, ref: 'viewer',
