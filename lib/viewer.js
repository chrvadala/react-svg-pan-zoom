...
var ReactSVGPanZoom = function (_React$Component) {
  ...
  _createClass(ReactSVGPanZoom, [{
    ...
    value: function handleEvent(event) {
      ...
      if (this.getTool() !== _constants.TOOL_NONE) return;
      var onEventHandler = eventsHandler[event.type];
      if (!onEventHandler) return;

      onEventHandler(new _viewerEvent2.default(event, value, this.ViewerDOM));
    }
  }, {
    ...
    value: function handleMouseDown(event) {
      var nextValue = (0, _interactions.onMouseDown)(event, this.ViewerDOM, this.getTool(), this.getValue(), this.props);
    ...
    value: function handlerMouseMove(event) {
      var _ViewerDOM$getBoundin = this.ViewerDOM.getBoundingClientRect(),
      ...
      var nextValue = (0, _interactions.onMouseMove)(event, this.ViewerDOM, this.getTool(), this.getValue(), this.props, { x: x, y: y });
    ...
    value: function handlerMouseUp(event) {
      var nextValue = (0, _interactions.onMouseUp)(event, this.ViewerDOM, this.getTool(), this.getValue(), this.props);
    ...
    value: function handlerMouseEnterOrLeave(event) {
      var nextValue = (0, _interactions.onMouseEnterOrLeave)(event, this.ViewerDOM, this.getTool(), this.getValue(), this.props);
    ...
    value: function render() {
      ...
      if (tool === _constants.TOOL_PAN) style = _extends({
        cursor: (0, _cursor2.default)(value.mode === _constants.MODE_PANNING ? 'grabbing' : 'grab')
      }, style);

      if (tool === _constants.TOOL_ZOOM_IN) style = _extends({
        cursor: 'zoom-in'
      }, style);

      if (tool === _constants.TOOL_ZOOM_OUT) style = _extends({
        cursor: 'zoom-out'
      }, style);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_toolbarWrapper2.default, {
