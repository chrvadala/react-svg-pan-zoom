...
var ReactSVGPanZoom = function (_React$Component) {
  ...
  _createClass(ReactSVGPanZoom, [{
    ...
    value: function handleMouseDown(event) {
      ...
      var nextValue = (0, _interactions.onMouseDown)(event, viewerCoords, this.props, this.state.value);
    ...
    value: function handlerMouseMove(event) {
      var viewerCoords = { x: event.nativeEvent.offsetX, y: event.nativeEvent.offsetY };
      var nextValue = (0, _interactions.onMouseMove)(event, viewerCoords, this.props, this.state.value);
    ...
    value: function handlerMouseUp(event) {
      var viewerCoords = { x: event.nativeEvent.offsetX, y: event.nativeEvent.offsetY };
      var nextValue = (0, _interactions.onMouseUp)(event, viewerCoords, this.props, this.state.value);
    ...
    value: function handlerWheel(event) {
      var viewerCoords = { x: event.nativeEvent.offsetX, y: event.nativeEvent.offsetY };
      var nextValue = (0, _interactions.onWheel)(event, viewerCoords, this.props, this.state.value);
    ...
    value: function handlerMouseEnterOrLeave(event) {
      var viewerCoords = { x: event.nativeEvent.offsetX, y: event.nativeEvent.offsetY };
      var nextValue = (0, _interactions.onMouseEnterOrLeave)(event, viewerCoords, this.props, this.state.value);
