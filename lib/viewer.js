...
var ReactSVGPanZoom = function (_React$Component) {
  ...
  _createClass(ReactSVGPanZoom, [{
    ...
    value: function handleEvent(event) {
      ...
      onEventHandler(new _viewerEvent2.default(event, value, ViewerDOM));
    }
  }, {
        ...
        _react2.default.createElement(
          'svg',
          {
            ...
            onMouseDown: function onMouseDown(event) {
              _this3.handleMouseDown(event);
              _this3.handleEvent(event);
            },
            onMouseMove: function onMouseMove(event) {
              _this3.handlerMouseMove(event);
              _this3.handleEvent(event);
            },
            onMouseUp: function onMouseUp(event) {
              _this3.handlerMouseUp(event);
              _this3.handleEvent(event);
            },
