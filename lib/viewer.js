...
var ReactSVGPanZoom = function (_React$Component) {
  ...
  function ReactSVGPanZoom(props, context) {
    ...
    tool = tool !== null ? tool : _constants.TOOL_NONE;
    value = value !== null ? value : (0, _common.getDefaultValue)(tool, viewerWidth, viewerHeight, SVGWidth, SVGHeight);

    _this.state = { value: value };
    _this.SVGViewer = null;
    return _this;
  }
  ...
  _createClass(ReactSVGPanZoom, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var nextValue = state.value;

      if (nextProps.value !== null && _typeof(nextProps.value) === 'object' && !(0, _common.sameValues)(nextProps.value, state.value)) {
    ...
    value: function changeTool(tool) {
      var nextValue = (0, _common.changeTool)(this.state.value, tool);
      this.setState({ value: nextValue });
      if (this.props.onChange) this.props.onChange(nextValue);
    }
  }, {
    ...
    value: function handleEvent(event) {
      ...
      onEventHandler(new _viewerEvent2.default(event, value, this.SVGViewer));
    }
  }, {
    ...
    value: function handleMouseDown(event) {
      var _SVGViewer$getBoundin = this.SVGViewer.getBoundingClientRect(),
          left = _SVGViewer$getBoundin.left,
          top = _SVGViewer$getBoundin.top;

      var x = event.clientX - Math.round(left);
      var y = event.clientY - Math.round(top);

      var nextValue = (0, _interactions.onMouseDown)(event, { x: x, y: y }, this.props, this.state.value);
    ...
    value: function handlerMouseMove(event) {
      var _SVGViewer$getBoundin2 = this.SVGViewer.getBoundingClientRect(),
          left = _SVGViewer$getBoundin2.left,
          top = _SVGViewer$getBoundin2.top;

      var x = event.clientX - Math.round(left);
      var y = event.clientY - Math.round(top);

      var nextValue = (0, _interactions.onMouseMove)(event, { x: x, y: y }, this.props, this.state.value);
    ...
    value: function handlerMouseUp(event) {
      var _SVGViewer$getBoundin3 = this.SVGViewer.getBoundingClientRect(),
          left = _SVGViewer$getBoundin3.left,
          top = _SVGViewer$getBoundin3.top;

      var x = event.clientX - Math.round(left);
      var y = event.clientY - Math.round(top);

      var nextValue = (0, _interactions.onMouseUp)(event, { x: x, y: y }, this.props, this.state.value);
    ...
    value: function handlerWheel(event) {
      var _SVGViewer$getBoundin4 = this.SVGViewer.getBoundingClientRect(),
          left = _SVGViewer$getBoundin4.left,
          top = _SVGViewer$getBoundin4.top;

      var x = event.clientX - Math.round(left);
      var y = event.clientY - Math.round(top);

      var nextValue = (0, _interactions.onWheel)(event, { x: x, y: y }, this.props, this.state.value);
    ...
    value: function handlerMouseEnterOrLeave(event) {
      var _SVGViewer$getBoundin5 = this.SVGViewer.getBoundingClientRect(),
          left = _SVGViewer$getBoundin5.left,
          top = _SVGViewer$getBoundin5.top;

      var x = event.clientX - Math.round(left);
      var y = event.clientY - Math.round(top);

      var nextValue = (0, _interactions.onMouseEnterOrLeave)(event, { x: x, y: y }, this.props, this.state.value);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'svg',
          {
            ref: function ref(SVGViewer) {
              return _this3.SVGViewer = SVGViewer;
            },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_toolbarWrapper2.default, { position: props.toolbarPosition, value: value, onChange: function onChange(value) {
